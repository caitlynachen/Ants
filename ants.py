...
class Bee(Insect):
    ...
    def action(self, colony):
        ...
        # BEGIN EC
        if self.scared and self.place.entrance != Hive: 
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while count <= self.max_range and len(bees) == 0 and place is not hive:
            bees = place.bees
            place = place.entrance
            count += 1
...
class HungryAnt(Ant):
    ...
    def action(self, colony):
        ...
        if self.digesting > 0:
            ...
            rand = random_or_none(self.place.bees)
            if rand:
                self.eat_bee(rand)
        # END Problem 6
...
# END Problem 13
    ...
    def action(self, colony):
        ...
        if self.true_queen == False:
            ...
            while place:
                if place.ant:
                    if place.ant.is_container and place.ant.contained_ant and not place.ant.contained_ant.is_doubled:
